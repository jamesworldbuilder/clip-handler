...
import { initConfigTabBindings } from './config-ui.js'
...
export function initMarqueeSystem() {
    window.applyMarquee = (el) => {
        ...
        if (textWidth > cWidth) {
            ...
            const dist = cWidth - textWidth - 64 // extended buffer explicitly guarantees right side clears the visible boundary
            el.animate([
